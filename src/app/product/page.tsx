    ...
    <div className="mt-[70px] px-[3.1rem] md:px-16 overflow-x-hidden scrollbar-none bg-[#040414] bg-[url('/images/grids.svg')] bg-[-7.2rem_top]">
      ...
      >
        ...
        <div className="whycontentholder">
          <div className="whycontent">
            <h3 className="text-2xl font-bold mb-4 text-[#00A3D9]">Create code without error</h3>
            <p className="text-lg">
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <h3 className="text-2xl font-bold mb-4 text-[#00A3D9]">Mathematical proof of correctness</h3>
              ...
              <ProductAccordion type="single" defaultValue="item-1" className="w-full divide-y divide-brandBlue/20">
                <ProductAccordionItem value="item-1" className="border-t border-brandBlue/20">
                  <ProductAccordionTrigger>
                    <h3 className="text-[26px] font-display text-brandBlue">1. Improved productivity</h3>
                  </ProductAccordionTrigger>
                ...
                <ProductAccordionItem value="item-2">
                  <ProductAccordionTrigger>
                    <h3 className="text-[26px] font-display text-brandBlue">2. Error free software</h3>
                  </ProductAccordionTrigger>
                  <ProductAccordionContent>
                ...
                <ProductAccordionItem value="item-3">
                  <ProductAccordionTrigger>
                    <h3 className="text-[26px] font-display text-brandBlue">3. Halving the time</h3>
                  </ProductAccordionTrigger>
                  <ProductAccordionContent>
